...
friend Complex operator+ (const Complex&a, double b) { //Overload-2
    Complex r(b);
    return (a+r); // Create temporary object and use overload-1
}

friend Complex operator+ (double b, const Complex&a) { //Overload-3
    Complex r(b);
    return (a+r); //Create temporary object and use overload-1
}
...
/*
Summary- 
Works fine with 3 overlaoded friend function. It also preserve the encapsulation.
*/